...
public class ThongKe1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_thong_ke1);

        // initializing variable for bar chart.
        barChart = findViewById(R.id.idBarChart);

        // creating a new bar data set.
        barDataSet1 = new BarDataSet(getBarEntriesOne(), "nike");
        barDataSet1.setColor(getApplicationContext().getResources().getColor(R.color.purple_200));
        barDataSet2 = new BarDataSet(getBarEntriesTwo(), "Adidas");
        barDataSet2.setColor(Color.BLUE);
        barDataSet3 = new BarDataSet(getBarEntriesThree(), "yonex");
        barDataSet3.setColor(Color.GREEN);
        barDataSet4 = new BarDataSet(getBarEntriesFour(), "puma");
    ...
    private ArrayList<BarEntry> getBarEntriesFour() {
        ...
        // adding new entry to our array list with bar
        // entry and passing x and y axis value to it.
        barEntries.add(new BarEntry(1f, 9));
